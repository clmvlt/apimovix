...
public class PharmacyPictureTransferController {
    ...
    public ResponseEntity<?> transferPharmacyInfosPictureToPharmacy(
        ...
        var optPharmacy = pharmacyService.findPharmacy(cip);
        ...
        // Transférer la photo
        PharmacyPicture transferredPicture = pharmacyService.copyPharmacyInfosPictureToPharmacy(pharmacy, pharmacyInfosPictureId);
